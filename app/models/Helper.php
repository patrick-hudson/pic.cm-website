...
class Helper {
    ...
    /*
     * @param  string  $string  Mime type (text/html)
     *
     * @return string File extention
     */

    public static function mimeToExt($string) {
        $mime_types_map = array(
            ...
            'java' => 'text/plain', 'java' => 'text/x-java-source', 'jcm' => 'application/x-java-commerce', 'jpg' => 'image/jpeg',
    ...
    public static function arrayToXml($data, $rootNodeName = 'data', $xml = null) {
        ...
        foreach ($data as $key => $value) {
            ...
            if (is_array($value)) {
                ...
                // recrusive call.
                Helper::arrayToXml($value, $rootNodeName, $node);
            } else {
                // add single node.
