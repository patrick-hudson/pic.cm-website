...
<div class="container">
    <div class="col-sm-12 col-md-12">
        <h1>piccm Copyright Policy</h1>
        <br><br>
        piccm has adopted the following policy concerning copyright infringement in accordance with the Digital Millennium Copyright Act, 17 U.S.C. 512. The contact information for piccm's Designated Agent to Receive Notification of Claimed Infringement ("Designated Agent") is listed at the end of this policy, and is on file with the United States Copyright Office (http://www.copyright.gov/onlinesp/list/index.html).
        piccm takes copyright and other intellectual property rights very seriously. It is piccm's policy to (1) expeditiously block access to or remove content that it believes in good faith may contain material that infringes the copyrights of third parties and (2) remove and discontinue service to repeat offenders.
        <br><br>
        <h1>Procedure for Reporting Copyright Infringements:</h1>
        <br><br>
        If you believe that content residing on or accessible through the piccm website or service infringes your copyright, please send a notice of claimed copyright infringement containing the following information to the Designated Agent listed below (consult legal counsel or refer to 17 U.S.C. 512(c) to confirm these requirements):
        <br><br>
        ...
        <br><br>
        3. Identification of the material that is claimed to be infringing or to be the subject of infringing activity and that is to be removed or access to which is to be disabled, and information reasonably sufficient to permit piccm to locate the material;
        <br><br>
        ...
        <br><br>
        Once a complete and proper notice of claimed copyright infringement is received by the Designated Agent, or if piccm otherwise comes to believe in good faith that a file on the piccm service may contain material that infringes copyright:
        <br><br>
        <b>It is piccm's policy:</b>
        <br><br>
        ...
        <br>
        <a name="counterNotice"></a>
        <br>
        <b>Procedure to Supply a Counter-Notice to the Designated Agent: </b>
        <br><br>
        ...
        <br><br>
        If a counter-notice is received by the Designated Agent, piccm may send a copy of the counter-notice to the original complaining party informing that person that it may replace the removed content or cease disabling it in 10 business days. Unless the copyright owner files an action seeking a court order against the content provider, member or user, the removed content may be replaced, or access to it restored, in 10 to 14 business days or more after receipt of the counter-notice, at piccm's sole discretion.
        <br><br>
        Please contact piccm's Designated Agent at the following address:
        <br><br>
