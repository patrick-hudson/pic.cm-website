...
<div class="container">
            ...
            <div class="well clearfix">
                <div class="col-xs-12 col-lg-2">
                    <span class="btn-group btn-group-justified">
                        <a id="delbut" class="btn btn-danger disabled"> <i class="glyphicon glyphicon-trash"></i> Delete selected</a>
                    </span>
                </div>
    ...
    <div class="row">
        <form autocomplete="off" id="imgcontainer">
            ...
            <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 gallery-img" id="img_{{ Helper::ImageID($image->imageid) }}">
                <div class="thumbnail">
