...
<html lang="en" class="no-js">
    ...
    <!-- start: HEAD -->
    <head>
        <title>Account suspended :: Pic.cm</title>
        <!-- start: META -->
        <meta charset="utf-8" />
            ...
            <div class="row">
                <div class="col-sm-12 page-error">
                    <div class="error-details col-sm-6 col-sm-offset-3">
                        ...
                        <p>
                            Sadly your account has been suspended.<br />
                            If you feel you have not broken any of the rules<br /> laid out
                            in our <a href="/tos">Terms of Service</a> please contact<br />
                            accounts@pic.cm to appeal the suspension.
                        </p>
                    </div>
                </div>
            </div>
